...
- Example: +5°C in March (spring) vs +5°C in November (autumn)
  → same temperature, but the TREND tells the season
...
STEP 4: Combine visual evidence + temperature + climate data to determine season.
