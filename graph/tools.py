...
print('Imports imported', flush=True)
...
async def get_city_climate(city_name: str) -> str:
    ...
    return context 
print('maybe this tool', flush=True)
@tool 
...
print('Do you know what antidepressants im on to deal with rhis kind of shit', flush=True)
@tool
    ...
    for season_name, months in seasons.items():
        ...
        if temps1 and temps2:
            ...
            if diff > 0:
                ...
                result += f"(equal)\n"
    return result
print('Not enough antidepressants i think', flush=True)
ALL_TOOLS = [
